...
class TestParentNode(unittest.TestCase):
    ...
    def test_parent_node_repr(self):
        ...
        parent = ParentNode("div", children)
        self.assertEqual(
            repr(parent), "ParentNode(div, children: [LeafNode(p, Child 1, None), LeafNode(span, Child 2, None)], None)"
        )
    ...
    def test_parent_node_repr_with_props(self):
        ...
        self.assertEqual(
            repr(parent),
            "ParentNode(div, children: [LeafNode(p, Child 1, None), LeafNode(span, Child 2, None)], {'class': 'container', 'id': 'main'})",
        )
